...
1.[GitHub官方中文学习文档](https://docs.github.com/zh)\

## 二、GitHub配套工具

1.[GitHub Desktop官方中文学习文档](https://docs.github.com/zh/desktop)

2.Visual Studio Code学习文档
* [VSCode文档](https://code.visualstudio.com/docs)
* [VSCode快速入门文档](https://code.visualstudio.com/docs/getstarted/getting-started)
